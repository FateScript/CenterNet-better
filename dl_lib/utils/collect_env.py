...
def collect_env_info():
    ...
    try:
        ...
        data.append(("dl_lib._C", "failed to import"))
    else:
        data.append(("dl_lib Compiler", _C.get_compiler_version()))
        data.append(("dl_lib CUDA Compiler", _C.get_cuda_version()))
